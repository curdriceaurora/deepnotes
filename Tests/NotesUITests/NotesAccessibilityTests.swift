...
final class NotesAccessibilityTests: XCTestCase {
    ...
    func testA11yLabels_MarkdownToolbarButtons() throws {
        ...
        // Insert Heading
        XCTAssertTrue(viewsSource.contains(".accessibilityIdentifier(\"insertHeadingButton\")"),
                      "insertHeadingButton must have accessibility identifier")
        XCTAssertTrue(viewsSource.contains(".accessibilityLabel(\"Insert Heading\")"),
                      "insertHeadingButton must have 'Insert Heading' label")
        XCTAssertTrue(viewsSource.contains(".accessibilityHint(\"Inserts a # heading at the cursor\")"),
                      "insertHeadingButton must have hint")

        // Insert Bullet
        XCTAssertTrue(viewsSource.contains(".accessibilityIdentifier(\"insertBulletButton\")"),
                      "insertBulletButton must have accessibility identifier")
        XCTAssertTrue(viewsSource.contains(".accessibilityLabel(\"Insert Bullet\")"),
                      "insertBulletButton must have 'Insert Bullet' label")
        XCTAssertTrue(viewsSource.contains(".accessibilityHint(\"Inserts a bullet list item\")"),
                      "insertBulletButton must have hint")

        // Insert Checkbox
        XCTAssertTrue(viewsSource.contains(".accessibilityIdentifier(\"insertCheckboxButton\")"),
                      "insertCheckboxButton must have accessibility identifier")
        XCTAssertTrue(viewsSource.contains(".accessibilityLabel(\"Insert Checkbox\")"),
                      "insertCheckboxButton must have 'Insert Checkbox' label")
        XCTAssertTrue(viewsSource.contains(".accessibilityHint(\"Inserts a task checkbox\")"),
    ...
    func testA11yLabels_SyncControls() throws {
        ...
        // Calendar field
        XCTAssertTrue(viewsSource.contains(".accessibilityIdentifier(\"syncCalendarField\")"),
                      "syncCalendarField must have accessibility identifier")

        // Run Sync button: identifier + label + hint
        XCTAssertTrue(viewsSource.contains(".accessibilityIdentifier(\"runSyncButton\")"),
                      "runSyncButton must have accessibility identifier")
        XCTAssertTrue(viewsSource.contains(".accessibilityLabel(\"Sync\")"),
                      "runSyncButton must have 'Sync' accessibility label")
        XCTAssertTrue(viewsSource.contains(".accessibilityHint(\"Runs calendar sync\")"),
